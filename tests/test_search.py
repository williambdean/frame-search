...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            'Hobby:Reading & `City of Interest`:"New York"',
            [0],
            id="multiple-conditions-amp",
        ),
        pytest.param(
            'Hobby:Reading AND `City of Interest`:"New York"',
            [0],
            id="multiple-conditions-and",
        ),
        pytest.param(
            'Hobby:Reading | `City of Interest`:"New York"',
            [0, 1, 2],
            id="multiple-conditions-vpipe",
        ),
        pytest.param(
            'Hobby:Reading OR `City of Interest`:"New York"',
            [0, 1, 2],
            id="multiple-conditions-or",
        ),
        pytest.param(
        ...
        pytest.param(
            '~(Hobby:Reading AND `City of Interest`:"New York")',
            [1, 2, 3],
            id="negation-multiple-conditions-and",
        ),
        pytest.param(
            '~(Hobby:Reading OR `City of Interest`:"New York")',
            [3],
            id="negation-multiple-conditions-or",
        ),
